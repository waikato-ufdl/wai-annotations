...
class ToTensorflowExampleCLIFactory(CLIFactory):
    """
    Factory which instantiates the ToTensorflowExample class.
    """
    # Options
    ...
    def production_class(self, namespace: Namespace) -> Type[CLIInstantiable]:
        from wai.annotations.tf.convert._ToTensorflowExample import ToTensorflowExample
