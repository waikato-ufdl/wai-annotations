...
class ToADAMSReportCLIFactory(CLIFactory):
    """
    Factory which instantiates the ToADAMSReport class.
    """
    # Options
    ...
    def production_class(self, namespace: Namespace) -> Type[CLIInstantiable]:
        from wai.annotations.adams.convert._ToADAMSReport import ToADAMSReport
