...
class IndexedPNGWriter(SeparateFileWriter[IndexedPNGFormat]):
    """
    Writes the indexed-PNG format to disk.
    """
    def write_annotations_only(self, instances: Iterable[IndexedPNGFormat], path: str):
    ...
    def extract_file_info_from_external_format(self, instance: IndexedPNGFormat) -> ImageInfo:
